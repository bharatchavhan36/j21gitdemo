...
public class Student {		//student		STUD_COURSES		STUD_ADDRESS  //Professors		PROF_COURSES	//dept		DEPT_STUDENTS		DEPT_STUDENTS	//course // college collegedept  collegeaddress	address
		@Id
		private int studId;
